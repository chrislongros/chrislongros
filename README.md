...
I am a medical doctor and an open-source developer focused on **FreeBSD/OpenZFS ecosystem**, **Arch Linux** packaging and **self-hosted infrastructure**. I also build tools around **spaced repetition learning** (Anki/FSRS).
